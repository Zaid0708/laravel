...
class AdminController extends Controller
{
    ...
    $reservations = Reservation::with('user', 'hotel')->take(4)->get();

    // Get the number of reservations per week for each hotel
