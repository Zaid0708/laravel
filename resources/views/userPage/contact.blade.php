            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="contact-text">
                        <h2>Get in Touch</h2>
                        <p>Have questions about booking your stay with Sona? Our team is here to assist you with any
                            inquiries regarding our wide selection of hotels across the globe. Contact us to learn more
                            about our offerings and how we can help make your travel planning seamless.</p>
                        <table>
                            <tbody>
                                <tr>
