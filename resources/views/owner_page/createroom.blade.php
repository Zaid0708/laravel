        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="booking-form">
                    ...
                    <form method="POST" action="{{ route('rooms.store', ['hotelId' => $hotelId]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="price_per_night" name="price_per_night" placeholder="Enter price per night" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="bed" name="bed" placeholder="Enter room bed" required>
                        </div>

                        <div class="form-group">
                            <label for="capacity">bathroom:</label>
                            <input type="number" class="form-control" id="bathroom" name="bathroom" placeholder="Enter room bathroom" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="size" name="size" placeholder="Enter room size" required>
                        </div>
