...
<body>
    ...
    <a href="#" class="text-dark text-decoration-none dropdown-toggle" id="notificationsDropdown" aria-expanded="false">
        ...
        <span class="badge badge-notification xl">{{$notifications}}</span> <!-- Example notification count -->
    </a>
    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationsDropdown">
        <li><a class="dropdown-item" href="#">new owner:{{$ownersCount}}</a></li>
                            ...
                            <tbody>
                                @foreach ($reservations as $reservation)
                                    <tr>
                                        ...
                                        <td>{{ $reservation->hotel ? $reservation->hotel->name : 'No hotel found' }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                @foreach ($reviews as $review)
                                    <tr>
                                        ...
                                        <td>
                                            @if($review->hotel->rooms->isNotEmpty())
                                                {{ $review->hotel->rooms->first()->availability_status }}
                                            @else
                                                N/A
                                            @endif
                                        </td>
